...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav
        className={`navbar d-flex justify-content-between  navbar-expand-lg navbar-${props.mode} bg-${props.mode}  `}
        id="navbar"
      >
              ...
              >
                {props.mode === "light" ? (
                  ...
                  <svg
                    ...
                    height="25"
                    fill="currentColor"
                    class="bi bi-brightness-high text-light"
                    viewBox="0 0 16 16"
                  >
