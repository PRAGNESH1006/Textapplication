          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <form className="d-flex" role="search">
              <input
                ...
                />
              <button
                className="btn btn-outline-success ms-600"
                type="submit"
                style={myStyle}
                >
                Search
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <svg
                ...
                height="25"
                fill="currentColor"
                className=" dropdown-item bi bi-moon-stars-fill"
                viewBox="0 0 16 16"
                onClick={darkMode}
              > 
              <span>t</span>
            ...
            <svg
                ...
                height="25"
                fill="currentColor"
                className="dropdown-item bi bi-brightness-high "
                viewBox="0 0 16 16"
                onClick={lightMode}
